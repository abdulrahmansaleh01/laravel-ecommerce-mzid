...
@section('title', 'Tambah Data Kupon | MZ.ID')
...
<div class="content-header-left col-md-6 col-12 mb-2">
    <h3 class="content-header-title mb-0">Tambah Kupon</h3>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="bordered-layout-basic-form">Tambah Data Kupon</h4>
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    <form action="/admin/coupon/create" class="form form-horizontal form-bordered" method="post">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="form-body">
                            <div class="form-group row">
                                <label class="col-md-2 label-control" for="coupon_code">Kode Kupon</label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="coupon_code" placeholder="Masukkan Kode Kupon" required="required" minlength="5" maxlength="15">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 label-control" for="amount">Jumlah Potongan</label>
                                <div class="col-md-7">
                                    <input type="number" class="form-control" name="amount" placeholder="Masukkan jumlah potongan" required="required" min="0">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <input type="text" class="form-control" name="expiry_date" placeholder="Masukkan Tanggal Kadaluarsa" required="required">
